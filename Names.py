print("Aaryan Kapur Developer, entrepeneur with a knack for problem solving. aaryankapur.tech")

print("Abhinav Robinson Developer|Designer and a ~music listening hobbist?~.")
